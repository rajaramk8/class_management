              ...
              {user ? (
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1.5 text-slate-600 hover:text-sky-600 hover:bg-sky-50 border border-slate-200 rounded-lg text-xs font-medium transition-colors"
                  ...
                  {/* Quick Role switcher for offline testing */}
                  {!isSupabaseConfigured && (
                    <button
